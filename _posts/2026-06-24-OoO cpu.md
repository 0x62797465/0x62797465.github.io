...
Look at that! Fewer hazards! But to prevent something like the third instruction executing before `x16` is written to, we mark `x16` as not-ready; we will mark it as ready in the write-back stage.
